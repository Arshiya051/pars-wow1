...
public sealed class TbcItemDisplaySchema : DbcSchemaBase<ItemDisplayInfoRecord>
{
    ...
    public override ItemDisplayInfoRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        Model1 = raw.GetStringOrDefault(1),
        Model2 = raw.GetStringOrDefault(2),
        Texture = raw.GetStringOrDefault(3),
        GeosetGroup = raw.GetInt32OrDefault(4)
    };
}

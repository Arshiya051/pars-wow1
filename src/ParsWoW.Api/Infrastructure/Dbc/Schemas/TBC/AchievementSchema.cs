...
public sealed class TbcAchievementSchema : DbcSchemaBase<AchievementRecord>
{
    ...
    public override AchievementRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        Faction = raw.GetInt32OrDefault(1),
        InstanceId = raw.GetInt32OrDefault(2),
        Title = raw.GetStringOrDefault(3),
        Description = raw.GetStringOrDefault(4),
        Category = raw.GetInt32OrDefault(5),
        Points = raw.GetInt32OrDefault(6),
        OrderInCategory = raw.GetInt32OrDefault(7)
    };
}

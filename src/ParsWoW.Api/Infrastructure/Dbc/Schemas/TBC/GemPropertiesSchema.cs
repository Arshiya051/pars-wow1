...
public sealed class TbcGemPropertiesSchema : DbcSchemaBase<GemPropertiesRecord>
{
    ...
    public override GemPropertiesRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        SpellItemEnchantment = raw.GetInt32OrDefault(1),
        MaxCount = raw.GetInt32OrDefault(2),
        MinLevel = raw.GetInt32OrDefault(3)
    };
}

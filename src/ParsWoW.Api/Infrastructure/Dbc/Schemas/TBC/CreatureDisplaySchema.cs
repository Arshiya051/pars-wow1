...
public sealed class TbcCreatureDisplaySchema : DbcSchemaBase<CreatureDisplayInfoRecord>
{
    ...
    public override CreatureDisplayInfoRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        ModelId = raw.GetInt32OrDefault(1),
        Texture1 = raw.GetStringOrDefault(2),
        Texture2 = raw.GetStringOrDefault(3),
        Scale = raw.GetFloatOrDefault(4)
    };
}

...
public sealed class TbcAreaTableSchema : DbcSchemaBase<AreaRecord>
{
    ...
    public override AreaRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        ContinentId = raw.GetInt32OrDefault(1),
        ParentAreaId = raw.GetInt32OrDefault(2),
        Flags = raw.GetInt32OrDefault(3),
        AreaName = raw.GetStringOrDefault(4)
    };
}

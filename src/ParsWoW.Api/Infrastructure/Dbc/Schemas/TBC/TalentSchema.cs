...
public sealed class TbcTalentSchema : DbcSchemaBase<TalentRecord>
{
    ...
    public override TalentRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        TabId = raw.GetInt32OrDefault(1),
        TierId = raw.GetInt32OrDefault(2),
        ColumnIndex = raw.GetInt32OrDefault(3),
        SpellId = raw.GetInt32OrDefault(4),
        Ranks = raw.GetInt32OrDefault(5)
    };
}

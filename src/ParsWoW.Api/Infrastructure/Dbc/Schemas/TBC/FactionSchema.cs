...
public sealed class TbcFactionSchema : DbcSchemaBase<FactionRecord>
{
    ...
    public override FactionRecord ProjectTyped(DbcRecord raw) => new()
    {
        ...
        ReputationRaceMask = raw.GetInt32OrDefault(1),
        Name = raw.GetStringOrDefault(2),
        Description = raw.GetStringOrDefault(3),
        Flags = raw.GetInt32OrDefault(4)
    };
}

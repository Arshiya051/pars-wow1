...
public sealed class LegionEnchantmentSchema : DbcSchemaBase<ItemEnchantmentRecord>
{
    ...
    {
        Id = raw.GetInt32OrDefault(0), Charges = raw.GetInt32OrDefault(1),
        EffectType = raw.GetInt32OrDefault(2), EffectSpellId = raw.GetInt32OrDefault(5),
        EffectAmount = raw.GetInt32OrDefault(8), Name = raw.GetStringOrDefault(11)
    };
}
